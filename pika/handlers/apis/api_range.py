...
def register_api_range_routes(app: FastAPI, logger):
    ...
    app.get("/api/range")(lambda start, end, max_points=1000: api_range(logger, start, end, max_points))


def api_range(logger, start: float, end: float, max_points: int = 1000):
