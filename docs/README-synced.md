...
![Pika-pika logo](images/Pika-pika.png)  
...
A project PNG (`images/Pika-pika.png`) is used as the site logo and social preview image. To generate favicons and optimized assets from that PNG run:
